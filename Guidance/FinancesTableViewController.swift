//
//  FinancesTableViewController.swift
//  Guidance
//
...
class FinancesTableViewController: UITableViewController {
    
    var financesList: [Finances]?
    ...
    override func viewDidLoad() {
        ...
        financesList = FinancesManager.getFinances(forLastMonths: 6)
    }
    ...
    override func tableView(_ tableView: UITableView, titleForHeaderInSection section: Int) -> String? {
        let date = financesList![section].monthFirstDate
